...
if (isset($_GET['delete'])) {
    ...
    if ($result2) {
        header("location:/reddrop/inventory_sheet/php/M_problem_Table.php"); 
    }
}
...
if (isset($_GET['id'])) {
    ...
    $User_FIRST_INSERT = "INSERT INTO A_ISSUES (`NAME`,`CONTACT`,`CNIC`,`ISSUE`, `LOGIN_ID`) VALUES('$name','$contact','$cnic','$issue','$_SESSION[LOGIN_ID_M]')";
