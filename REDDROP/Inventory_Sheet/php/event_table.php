...
if (isset($_POST['F_Submit'])) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $e_date = $_POST['e_date'];
        $amount = $_POST['amount'];
        $Food1_FIRST_INSERT = "INSERT INTO `EVENT` (`EVENT_TYPE`,`CONTACT`,`DATE`,`AMOUNT`,`LOGIN_ID`) VALUES('$e_type','$number','$e_date','$amount','$_SESSION[login_id]')";
            ...
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form action="/reddrop/inventory_sheet/php/eventscript.php" method="POST">
        ...
        <div class="modal fade " id="insertModal" tabindex="-1" aria-labelledby="insertModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form action="/reddrop/inventory_sheet/php/event_Table.php" method="POST">
            ...
            <table class="table table-dark table-striped table-responsive" id="myTable">
                ...
                <tbody>
                    <div class="table">
                        ...
                        "SELECT *FROM `EVENT` WHERE `event`.`LOGIN_ID` IS NULL";
            ...
            Array.from(deletes).forEach((element) => {
                element.addEventListener("click", (e) => {
                    ...
                    if (confirm("You want to delete this record?")) {
                        console.log("yes");
                        window.location = `/reddrop/inventory_sheet/php/eventscript.php?delete=${sno}`;
                    }
