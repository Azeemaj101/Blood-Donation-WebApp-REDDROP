            ...
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form action="/reddrop/inventory_sheet/php/M_problemscript.php" method="POST">
        ...
        <div class="modal fade " id="insertModal" tabindex="-1" aria-labelledby="insertModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form action="/reddrop/inventory_sheet/php/M_problem_Table.php" method="POST">
        ...
        <script>
            ...
            Array.from(approve).forEach((element) => {
                element.addEventListener("click", (e) => {
                    ...
                    issue = tr.getElementsByTagName("td")[3].innerText;
                    console.log(issue);
                    window.location = `/reddrop/inventory_sheet/php/M_problemscript.php?id=${e.target.id}&name=${name}&contact=${contact}&cnic=${cnic}&issue=${issue}`;
                })
            })
            ...
            Array.from(a_deletes).forEach((element) => {
                element.addEventListener("click", (e) => {
                    ...
                    if (confirm("You want to delete this record?")) {
                        console.log("yes");
                        window.location = `/reddrop/inventory_sheet/php/M_problemscript.php?a_delete=${sno}`;
                    }
            ...
            Array.from(deletes).forEach((element) => {
                element.addEventListener("click", (e) => {
                    ...
                    if (confirm("You want to delete this record?")) {
                        console.log("yes");
                        window.location = `/reddrop/inventory_sheet/php/M_problemscript.php?delete=${sno}`;
                    }
