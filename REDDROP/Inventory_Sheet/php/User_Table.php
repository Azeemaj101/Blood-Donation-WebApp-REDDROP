    ...
    <section>
        ...
        <div class="bd-highlight mt-5 px-5">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="USER_PDF.php"><button type="button" class="btn btn-warning btn-lg hov">
            ...
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form class="container" action="/reddrop/inventory_sheet/php/User_table.php" method="POST" enctype="multipart/form-data">
                            <fieldset>
                                <div class="mb-3 row">
                                    <div class="col">
                                ...
                                <div class="mb-3 row">
                                    <div class="col">
                                        <input type="text" placeholder="Your Username*" name="username" class="form-control" aria-describedby="nameHelp">
                                    </div>
                                    <div class="col">
        ...
        <div class="modal fade " id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form class="container" action="/reddrop/inventory_sheet/php/Userscript.php" method="POST" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="mb-3 row">
                                    <div class="col">
                                        <input type="text" placeholder="Your Username*" name="u_username" id="u_username" class="form-control" aria-describedby="nameHelp">
                                    </div>
                                    <div class="col">
            ...
            Array.from(deletes).forEach((element) => {
                element.addEventListener("click", (e) => {
                    ...
                    if (confirm("You want to delete this record?")) {
                        ...
                        window.location = `/reddrop/inventory_sheet/php/Userscript.php?delete=${sno}`;
                    }
